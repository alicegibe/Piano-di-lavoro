...
% Dati dello Studente
\newcommand{\nomeStudente}{Alice}
\newcommand{\cognomeStudente}{Gibellato}
\newcommand{\matricolaStudente}{1197756}
\newcommand{\emailStudente}{alice.gibellato@studenti.unipd.it}
\newcommand{\telStudente}{+ 39 380 10 52 750}

% Dati del Tutor Aziendale
\newcommand{\nomeTutorAziendale}{Matteo}
\newcommand{\cognomeTutorAziendale}{Lora}
\newcommand{\emailTutorAziendale}{matteo.lora@unox.it}
\newcommand{\telTutorAziendale}{+ 39 000 00 00 000}
\newcommand{\ruoloTutorAziendale}{Matteo Lora}

% Dati dell'Azienda
\newcommand{\ragioneSocAzienda}{Unox S.p.A}
\newcommand{\indirizzoAzienda}{Via Ettore Majorana, 22 Cap 35010 Città Cadoneghe (PD)}
\newcommand{\sitoAzienda}{https://www.unox.com/it_it/}
\newcommand{\partitaIVAAzienda}{P.IVA 04230750285}

% Dati del Tutor Interno (Docente)
\newcommand{\titoloTutorInterno}{Prof. Ombretta Gaggi}
